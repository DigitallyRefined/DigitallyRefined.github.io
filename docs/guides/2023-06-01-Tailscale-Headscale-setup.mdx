...
Fly.io no longer offer free [dedicated IPv4 addresses](https://fly.io/docs/about/pricing/#anycast-ip-addresses). Mentions of this being a free service in the video below are now no longer correct.
